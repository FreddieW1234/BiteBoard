...
def fetch_all_metafields(product_id):
    ...
    for m in metafields:
        ...
        elif namespace == 'custom' and key in ['artworkguidelines', 'artworktemplates', 'stockdesigns', 'packaging if applicable', 'packaging_if_applicable', 'product_colours', 'packaging_colours']:
            m['_filtered'] = True
